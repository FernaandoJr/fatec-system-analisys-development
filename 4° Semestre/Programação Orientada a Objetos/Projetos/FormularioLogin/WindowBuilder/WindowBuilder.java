...
public class WindowBuilder {
	public static void main(String[] args) {
		...
		OnFocusEventHelper.setOnFocusText(inputPassword, "Digite sua senha", Color.decode("#000"), Color.decode("#73664e"));
		...
		btnLogin.addActionListener(e -> {
			try {
				...
				JOptionPane.showMessageDialog(frame, "Ocorreu um erro inesperado.");
			} finally {
		...
		OnClickEventHelper.setOnClickColor(btnLogin, Color.decode("#7c6f97"), Color.decode("#bca8e4"));
